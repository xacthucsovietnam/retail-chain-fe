    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-white shadow-md transition-transform duration-300">
        <div className="px-4 py-3">
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-xl font-bold text-gray-800">Danh Sách Phiếu Thu Tiền Mặt</h2>
            <button
          ...
          <div className="space-y-3">
            <div className="relative">
              <input
                ...
                placeholder="Tìm kiếm theo số phiếu thu..."
      ...
      <div className="hidden md:block bg-white rounded-lg shadow-md p-6 mb-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-gray-800">Danh Sách Phiếu Thu Tiền Mặt</h2>
          <button
            onClick={() => navigate('/cash-receipts/add')}
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center text-gray-700">
                    ...
                    <span className="text-sm">{receipt.cashAccount}</span>
                  </div>
